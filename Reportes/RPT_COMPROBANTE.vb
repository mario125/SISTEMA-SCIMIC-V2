...
Public Class RPT_COMPROBANTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.RPT_COMPROBANTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_COMPROBANTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_COMPROBANTE = New RPT_COMPROBANTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
